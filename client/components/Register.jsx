    ...
    return (
      <form className="center-form Register form box" onSubmit={this.submit}>
        ...
        <div className="form-row">
          <label className="column is-6 is-offset-one-quarter label is-large has-text-centered" htmlFor="user_name">
            Username
          </label>
          <input
            required
        ...
        <div className="form-row">
          <label className="column is-6 label is-large has-text-centered" htmlFor="password">
            Password
          </label>
          <input
            required
        ...
        <div className="form-row">
          <label className="column is-6 label is-large has-text-centered" htmlFor="confirm_password">
            Confirm Password
          </label>
          <input
            required
        ...
        <div className="form-row">
          <label className="column is-6 label is-large has-text-centered" htmlFor="actual_name">
            Full Name
          </label>
          <input
            required
        ...
        <hr />
        After registering your account, we will then finish creating and hooking it up for you, so please make sure you
        include both your first and last name so we recognise who you are :)
